...
QT_INSTALL_PATH="-prefix /usr/local/qt/qt5.6.3_shared"     # Qt安装路径(自己对应修改)
...
CONFIG_PARAM+="-qt-xkbcommon-x11 -qt-xcb "    # 使用自带的xkbcommon-x11 xcb
...
#  -sql-mysql 
CONFIG_PARAM+="-c++std c++11 -qt-xcb -qt-zlib -qt-libpng -qt-libjpeg -openssl -qpa xcb "
