...
QT_INSTALL_PATH="-prefix /usr/local/qt/qt5.4.0_shared"     # Qt安装路径(自己对应修改)
...
CONFIG_PARAM+="-system-xkbcommon -qt-xcb "    # 使用系统的xkbcommon/自带的xcb

CONFIG_PARAM+="-no-glib -system-harfbuzz "    # 不编译glib支持
...
CONFIG_PARAM+="-I/usr/include/openssl-1.0/ -L/usr/lib/openssl-1.0/ -L/usr/lib/ "

#  -sql-mysql 
CONFIG_PARAM+="-c++11 -qt-zlib -qt-libpng -qt-libjpeg -openssl -qpa xcb "
