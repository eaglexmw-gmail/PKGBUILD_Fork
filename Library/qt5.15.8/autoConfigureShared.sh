...
QT_INSTALL_PATH="-prefix /usr/local/qt/qt5.15.8_shared"     # Qt安装路径(自己对应修改)
...
CONFIG_PARAM+="-fontconfig  -L /usr/lib "
CONFIG_PARAM+="-qt-webengine-webp "

#  -sql-mysql 
CONFIG_PARAM+=" -no-pch -c++std c++14 -xcb -xcb-xlib -xkbcommon -qt-zlib -qt-libpng -qt-libjpeg -openssl -qpa xcb "
