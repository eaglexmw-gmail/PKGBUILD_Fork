...
QT_INSTALL_PATH="-prefix /usr/local/qt/qt6.4.2_shared"     # Qt安装路径(自己对应修改)
...
CONFIG_PARAM+="-skip qtquick3dphysics,qtopcua,qtmultimedia,qtwebengine,qttest " # 禁止testlib特性，以规避qtdeclarative中Qt5QuickTest链接失败问题 -skip qtdeclarative"

#  -sql-mysql 
CONFIG_PARAM+=" -no-gstreamer -no-sql-ibase -no-sql-mysql -no-pch -c++std c++17 -xcb -xcb-xlib -xkbcommon -qt-zlib -qt-libpng -qt-libjpeg -qt-tiff -qt-webp -openssl -qpa xcb "
