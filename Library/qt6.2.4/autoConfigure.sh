...
QT_INSTALL_PATH="-prefix /usr/local/qt/qt6.2.4"     # Qt安装路径(自己对应修改)
...
CONFIG_PARAM+="-skip qtwebengine,qttest " # -no-feature-testlib " # 禁止testlib特性，以规避qtdeclarative中Qt5QuickTest链接失败问题 -skip qtdeclarative"
