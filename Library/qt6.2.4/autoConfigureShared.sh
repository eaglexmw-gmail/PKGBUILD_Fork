...
QT_INSTALL_PATH="-prefix /usr/local/qt/qt6.2.4_shared"     # Qt安装路径(自己对应修改)
...
CONFIG_PARAM+="-skip qtwebengine,qttest " # 禁止testlib特性，以规避qtdeclarative中Qt5QuickTest链接失败问题 -skip qtdeclarative"
