...
sed -i 's|LIBS          = |& -pthread -rdynamic -L../ -lmonkeystudio -L/home/eaglexmw/x32/monkeystudio/src/mks_1.9.0.4-src/build/Linux-i386/release  -Wl,--whole-archive -lfresh -lctags -lqCtagsSense -Wl,--no-whole-archive -L/usr/local/qt/qt4.7.1_sym/lib/plugins/sqldrivers -lqsqlite -lsqlite3 -lmonkeystudio # |g' monkey/Makefile

find ./plugins/ -iname Makefile -exec sed -i 's|LIBS          = |& -Wl,-rpath,-/usr/local/monkeystudio/lib -L/home/eaglexmw/x32/monkeystudio/src/mks_1.9.0.4-src/ -lmonkeystudio # |g' {} \;
